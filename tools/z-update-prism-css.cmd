...
set "SCRAPED_URLROOT=https://cdn.skypack.dev/prismjs/themes"
...
set "dstfile=%DESTDIR%/prism.css"
if "xy" == "xN" if not exist "%dstfile%" call 7z e %FILENAME% prism.css -o%DESTDIR%
